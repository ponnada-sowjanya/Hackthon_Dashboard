...
function Alltemp() {
  const templates = [
    { id: 1, title: "Template 1", image: "/template1.png" },
    { id: 2, title: "Template 2", image: "/template2.png" },
    { id: 3, title: "Template 3", image: "/template3.png" },
    { id: 4, title: "Template 4", image: "/template4.png" },
    { id: 5, title: "Template 5", image: "/template5.png" },
    { id: 6, title: "Template 6", image: "/template6.png" },
    { id: 7, title: "Template 7", image: "/template7.png" },
    { id: 8, title: "Template 8", image: "/template8.png" },
  ];
  ...
  return (
    <div style={styles.app}>
      ...
      <div style={styles.nav}>
        <Link to="/" style={styles.templates}> <FontAwesomeIcon icon={faFile} style={{width:"40px",textDecoration:'none'}} />All Templates</Link>
        <Link to="/Simply" style={styles.simple} ><FontAwesomeIcon icon={faWandSparkles} style={{width:"40px"}} />Simple</Link>
        <Link to="/Ats" style={styles.ats}><FontAwesomeIcon icon={faBullseye} style={{width:"40px",marginRight:"5px"}}/> ATS</Link>
