...
function Prof() {
  const templates = [
    { id: 1, title: "Template 1", image: "/prof 1.png" },
    { id: 2, title: "Template 2", image: "/prof 2.png" },
    { id: 3, title: "Template 3", image: "/prof 3.png" },
    { id: 4, title: "Template 4", image: "/prof 4.png" },
    { id: 5, title: "Template 5", image: "/prof 5.png" },
    { id: 6, title: "Template 6", image: "/prof 6.png" },
    { id: 7, title: "Template 7", image: "/prof 7.png" },
    { id: 8, title: "Template 8", image: "/prof 8.png" },
  ];
  ...
  return (
    <div style={styles.app}>
      ...
      <div style={styles.nav}>
        ...
        <Link to="/" style={styles.prof}><FontAwesomeIcon icon={faBriefcase} style={{width:"40px", marginRight:"5px"}}/>Professional</Link>
      </div>
